...
def do_question_L():
    ...
    """
    audio.play(filename="/home/pi/pibo/src/data/audio/물음표소리1.wav", out='local', volume=-1000, background=False)
...
def do_praise_L():
    audio.play(filename="/home/pi/pibo/src/data/audio/경쾌한음악.wav", out='local', volume=-1000, background=False)
...
def do_agree():
    audio.play(filename="/home/pi/pibo/src/data/audio/딩동댕3.wav", out='local', volume=-1000, background=False)
...
def do_joy():
    audio.play(filename="/home/pi/pibo/src/data/audio/기분좋음.mp3", out='local', volume=-1000, background=False)
...
def do_sad():
    audio.play(filename="/home/pi/pibo/src/data/audio/슬픈소리.wav", out='local', volume=-1000, background=False)
